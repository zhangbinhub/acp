package io.github.zhangbinhub.acp.cloud.aspect
...
class RestControllerRepeatAspect(private val distributedLock: DistributedLock, private val objectMapper: ObjectMapper) {
     ...
     * 定义拦截规则
     */
    @Pointcut(value = "execution(public * *(..)) && @annotation(io.github.zhangbinhub.acp.cloud.annotation.AcpCloudDuplicateSubmission)")
    fun executeService() {
    }
