package com.github.zhangbinhub.acp.cloud.aspect
...
import com.github.zhangbinhub.acp.cloud.annotation.AcpCloudDuplicateSubmission
...
class RestControllerRepeatAspect(private val distributedLock: DistributedLock, private val objectMapper: ObjectMapper) {
     ...
     * 定义拦截规则
     */
    @Pointcut(value = "execution(public * *(..)) && @annotation(com.github.zhangbinhub.acp.cloud.annotation.AcpCloudDuplicateSubmission)")
    fun executeService() {
    }
